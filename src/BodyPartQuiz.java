...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// Windows Shift F!!! For Auto formating!
		initializeGui();
		{
		...
		for (int i = 0; i < 4; i++) {
			...
			if (guess.equals("arnold") && i== 0)   {
				...
				JOptionPane.showMessageDialog(null, "You are correct! Your score has gone up by one!");
				score++;
			}
			...
			// -- Tell them they are wrong and who the person is
				...
				JOptionPane.showMessageDialog(null, "No you are wrong."); }
